...
export const login = (credentials) => axios.post('http://localhost:3000/login', credentials);
export const register = (data) => axios.post('http://localhost:3000/register', data);